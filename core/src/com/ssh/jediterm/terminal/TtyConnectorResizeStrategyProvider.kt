...
enum class TtyConnectorResizeStrategy {
  /**
   * Resize the [TtyConnector] immediately together with [com.ssh.jediterm.terminal.model.TerminalTextBuffer] resize.
   */
  IMMEDIATE,

  /**
   * Resize of [TtyConnector] will be done some time after [com.ssh.jediterm.terminal.model.TerminalTextBuffer] resize.
   */
  POSTPONED,
}