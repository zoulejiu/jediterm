package com.ssh.jediterm.terminal.util;
...
public class CharUtils {
  ...
  private static final DoubleWidthProvider DOUBLE_WIDTH_PROVIDER =
          "legacy".equals(System.getProperty("com.ssh.jediterm.terminal.double_width_provider"))
   ...
   * {@code com.ssh.jediterm.terminal.double_width_provider=legacy}; otherwise {@link WidecharwidthProvider} is used.
   */
