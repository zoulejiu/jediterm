...
public class TerminalTypeAheadManager {
  ...
  public static class TypeAheadEvent {
    ...
    // @see terminal.com.ssh.jediterm.TerminalKeyEncoder
  ...
  private @NotNull TypeAheadPrediction createPrediction(@NotNull TypeAheadTerminalModel.LineWithCursorX initialLineWithCursorX,
    ...
    TypeAheadTerminalModel.LineWithCursorX newLineWCursorX;
  ...
  private static class HardBoundary extends TypeAheadPrediction {
    public HardBoundary() {
      super(new TypeAheadTerminalModel.LineWithCursorX(new StringBuffer(), -100), false); // will never match because cursorX can't be negative
    }
  }
  ...
  private static class CharacterPrediction extends TypeAheadPrediction {
    ...
    public CharacterPrediction(TypeAheadTerminalModel.LineWithCursorX predictedLineWithCursorX,
                               char character,
  ...
  private static class CursorMovePrediction extends TypeAheadPrediction {
    ...
    public CursorMovePrediction(TypeAheadTerminalModel.LineWithCursorX predictedLineWithCursorX,
                                int amount,
                                boolean isNotTentative) {
      super(predictedLineWithCursorX, isNotTentative);
      myAmount = amount;
