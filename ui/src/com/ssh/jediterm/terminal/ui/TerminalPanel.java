...
import com.ssh.jediterm.terminal.util.Pair;
...
public class TerminalPanel extends JComponent implements TerminalDisplay, TerminalActionProvider {
  ...
  private com.ssh.jediterm.core.compatibility.Point mySelectionStartPoint = null;
  ...
  public void init(@NotNull JScrollBar scrollBar) {
    ...
    addMouseMotionListener(new MouseMotionAdapter() {
      ...
      public void mouseDragged(final MouseEvent e) {
        ...
        final com.ssh.jediterm.core.compatibility.Point charCoords = panelToCharCoords(e.getPoint());
        ...
        if (mySelection == null) {
          ...
          mySelection = new TerminalSelection(new com.ssh.jediterm.core.compatibility.Point(mySelectionStartPoint));
        }
        repaint();
      ...
      public void mouseClicked(final MouseEvent e) {
        ...
        if (hyperlink != null) {
          ...
          if (count == 1) {
            ...
            // select word
            final com.ssh.jediterm.core.compatibility.Point charCoords = panelToCharCoords(e.getPoint());
            com.ssh.jediterm.core.compatibility.Point start = SelectionUtil.getPreviousSeparator(charCoords, myTerminalTextBuffer);
            com.ssh.jediterm.core.compatibility.Point stop = SelectionUtil.getNextSeparator(charCoords, myTerminalTextBuffer);
            ...
            mySelection = new TerminalSelection(new com.ssh.jediterm.core.compatibility.Point(0, startLine));
            mySelection.updateEnd(new com.ssh.jediterm.core.compatibility.Point(myTermSize.getColumns(), endLine));
  ...
  protected @Nullable SubstringFinder.FindResult selectPrevOrNextFindResultItem(boolean next) {
    if (myFindResult != null && !myFindResult.getItems().isEmpty()) {
      ...
      mySelection = new TerminalSelection(new com.ssh.jediterm.core.compatibility.Point(item.getStart().x, item.getStart().y - myTerminalTextBuffer.getHistoryLinesCount()),
        new com.ssh.jediterm.core.compatibility.Point(item.getEnd().x, item.getEnd().y - myTerminalTextBuffer.getHistoryLinesCount()));
  ...
  private @NotNull com.ssh.jediterm.core.compatibility.Point panelToCharCoords(final java.awt.Point p) {
    Cell cell = panelPointToCell(p);
    return new com.ssh.jediterm.core.compatibility.Point(cell.getColumn(), cell.getLine());
  }
  ...
  private void copySelection(@Nullable com.ssh.jediterm.core.compatibility.Point selectionStart,
                             @Nullable com.ssh.jediterm.core.compatibility.Point selectionEnd,
  ...
  private boolean inSelection(int x, int y) {
    return mySelection != null && mySelection.contains(new com.ssh.jediterm.core.compatibility.Point(x, y));
  }
  ...
  @Override
  public @Nullable com.ssh.jediterm.core.Color getWindowForeground() {
    return AwtTransformers.fromAwtColor(getForeground());
  }

  @Override
  public @Nullable com.ssh.jediterm.core.Color getWindowBackground() {
    ...
    addMouseListener(new MouseAdapter() {
      ...
      public void mousePressed(MouseEvent e) {
        if (mySettingsProvider.enableMouseReporting() && isRemoteMouseAction(e)) {
          com.ssh.jediterm.core.compatibility.Point p = panelToCharCoords(e.getPoint());
  ...
  public class TerminalCursor {
    ...
    protected com.ssh.jediterm.core.compatibility.Point myCursorCoordinates = new com.ssh.jediterm.core.compatibility.Point();
  ...
  public void selectAll() {
    mySelection = new TerminalSelection(new com.ssh.jediterm.core.compatibility.Point(0, -myTerminalTextBuffer.getHistoryLinesCount()),
      new com.ssh.jediterm.core.compatibility.Point(myTermSize.getColumns(), myTerminalTextBuffer.getScreenLinesCount()));
  }
  ...
  private String getSelectionText() {
    if (mySelection != null) {
      Pair<com.ssh.jediterm.core.compatibility.Point, com.ssh.jediterm.core.compatibility.Point> points = mySelection.pointsForRun(myTermSize.getColumns());
